;* --------BEGIN--------
;* D:\Projects\Cerebus\Atari\RetroDschump\src\music\DschumpMiker.rmt
FEAT_SFX		= 1
FEAT_GLOBALVOLUMEFADE	= 0		;RMTGLOBALVOLUMEFADE variable
FEAT_NOSTARTINGSONGLINE	= 0
FEAT_INSTRSPEED		= 1
FEAT_CONSTANTSPEED		= 0		;(9 times)
FEAT_COMMAND1		= 1		;(37 times)
